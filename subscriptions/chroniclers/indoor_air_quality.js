...
const window = Number.parseInt(process.env.IAQ_AVERAGE_WINDOW, 10);

const nextAverage = (newValue, prevAvg, count) =>
  (prevAvg * count + newValue) / (count + 1);
